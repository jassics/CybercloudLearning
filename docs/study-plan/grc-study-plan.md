...
This page is updated based on [jassics/security-study-plan/grc-study-plan](https://github.com/jassics/security-study-plan/blob/main/grc-study-plan.md)

A detailed study plan for Governance, Risk, and Compliance (GRC) professionals and beginners. Pair it with the site's own [GRC Overview](../grc/grc-overview.md), [ISO/IEC 27001](../grc/iso27k1.md), [NIST RMF](../grc/nist-rmf.md), and [NIST CSF](../grc/nist-csf.md) pages for the framework deep dives.
...
5. [GRC Roles & Career Path](#grc-roles--career-path)
...
- [Practical GRC Series: Part 1](https://www.youtube.com/watch?v=mq_vSLHm4r0) by Prabh Nair
- [Practical GRC Series: Part 2](https://www.youtube.com/watch?v=Zfq3eJNvZdY) by Prabh Nair
...
- [ISO 27001 resources](https://www.iso27001security.com/)
- [NIST RMF (SP 800-37r2)](https://nvlpubs.nist.gov/nistpubs/SpecialPublications/NIST.SP.800-37r2.pdf)
